...
export const TableDemo = () => {
    ...
    const [customer1, setCustomer1] = useState<any>(null);
    const [customer2, setCustomer2] = useState<any>(null);
    const [customer3, setCustomer3] = useState<any>(null);
    const [selectedCustomers, setSelectedCustomers] = useState<any>(null);
    const [globalFilter1, setGlobalFilter1] = useState<string>('');
    const [globalFilter2, setGlobalFilter2] = useState<string>('');
    ...
    const countryBodyTemplate = (data: any) => {
        return (
            <>
    ...
    const reviewsBodyTemplate = (data: any) => {
        return (
            <>
    ...
    const productStatusBodyTemplate = (data: any) => {
        return (
            <>
                <span className="p-column-title">Status</span>
