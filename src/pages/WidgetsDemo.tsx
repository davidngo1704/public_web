...
const setOverviewColors = (colorMode: string) => {
...
const getOverviewColors = (colorMode: string) => {
...
export const WidgetsDemo = (props: any) => {

    const menu15 = useRef<any>(null);
    const menu16 = useRef<any>(null);
    const menu17 = useRef<any>(null);
    const menu18 = useRef<any>(null);
                ...
                <div className="card overview-box p-d-flex p-flex-column p-pt-2 cyan-bgcolor solid-surface-text-color">
                    <div className="p-d-flex p-ai-center">
                        ...
                        <div className={classNames({ 'p-ml-auto': !isRTL, 'p-mr-auto': isRTL })}>
                            <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text solid-surface-text-color" onClick={(event: any) => menu15.current.toggle(event)}></Button>
            ...
            <div className="p-col-12 p-md-6 p-lg-3">
                <div className="card overview-box p-d-flex p-flex-column p-pt-2 orange-bgcolor solid-surface-text-color">
                    <div className="p-d-flex p-ai-center">
                        ...
                        <div className={classNames({ 'p-ml-auto': !isRTL, 'p-mr-auto': isRTL })}>
                            <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text solid-surface-text-color" onClick={(event) => menu16.current.toggle(event)}></Button>
            ...
            <div className="p-col-12 p-md-6 p-lg-3">
                <div className="card overview-box p-d-flex p-flex-column p-pt-2 pink-bgcolor solid-surface-text-color">
                    <div className="p-d-flex p-ai-center">
                        ...
                        <div className={classNames({ 'p-ml-auto': !isRTL, 'p-mr-auto': isRTL })}>
                            <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text solid-surface-text-color" onClick={(event: any) => menu17.current.toggle(event)}></Button>
            ...
            <div className="p-col-12 p-md-6 p-lg-3">
                <div className="card overview-box p-d-flex p-flex-column p-pt-2 purple-bgcolor solid-surface-text-color">
                    <div className="p-d-flex p-ai-center">
                        ...
                        <div className={classNames({ 'p-ml-auto': !isRTL, 'p-mr-auto': isRTL })}>
                            <Button type="button" icon="pi pi-ellipsis-h" className="p-button-rounded p-button-text solid-surface-text-color" onClick={(event: any) => menu18.current.toggle(event)}></Button>
            ...
            <div className="p-col-12 p-md-6 p-mb-4">
                <div className="card widget-overlay p-mt-5 height-100">
                    <div className="overlay-header p-p-3">
                        <Chart type="line" data={chartData} options={chartOptions} height="100%"></Chart>
                    </div>
